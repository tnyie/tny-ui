...
// Vue.use(VueChartJS)
// export default {
//   mixins: [Line, chartMixins.reactiveProp],
//   props: ['chartdata', 'options'],
//   mounted () {
//     // const linkObjs = await links.FetchOwnLinks();
//     // const visit = await visits.FetchLinkVisits(linkObjs[0].id);
//     // this.chart.visits = visit.map(visit => visit.count)
//     // this.chart.labels = visit.map(visit => visit.date)

//     // console.log("Visits: ", this.chart.visits)
//     // console.log("Labels: ", this.chart.labels)
//     // console.log(visit);
//     // console.table(visit)
